...
## อัปเดตคำสั่งเจ้าของ: ส่งข้อกำหนดก่อน งานดีไซน์ตามมา
เจ้าของยืนยันให้เผยแพร่เอกสารชุดนี้ผ่านรีโปสาธารณะนี้แล้ว และสั่งให้ส่ง C ก่อนโดยไม่ต้องรอภาพดีไซน์จบ
GPT เป็นผู้คุมการออกแบบต่อ: ทีมเราจะทำหน้าจอและสถานะทั้งหมดตาม Home23/Chat24 ตรวจความสวยงามและการใช้งาน แล้วส่งภาพพร้อมข้อกำหนดฉบับปรับตามมา
ขอ C เริ่มตรวจ contract/ช่องข้อมูล/กฎหลังบ้านและตอบช่องว่างได้ก่อน ไม่ยึดหน้าตา HTML ทดลองเป็นดีไซน์สุดท้าย และไม่เปลี่ยนแบบที่เจ้าของอนุมัติเอง การส่งครั้งนี้ไม่ใช่คำสั่ง deploy หรือทดสอบเขียนข้อมูล production
